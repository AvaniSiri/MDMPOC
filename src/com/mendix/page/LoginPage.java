...
public class LoginPage {
	...
	public void google(){
		google.sendKeys("Tets");
	}
	
	

	public void login(String strUsername,String strPassword ){
		Sync.waitForObject(driver, "Username", txtNewUsername);
		Textbox.enterValue("Login User Name", txtNewUsername, strUsername);
		Textbox.enterValue("Login Password", txtNewPassword, strPassword);
		Button.click("Login Button", loginNewBtn);
	}
