...
public class MaterialApprovalPage {
...

	{
		...
		//wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[text()='My Tasks']")));
		...
		Sync.waitForSeconds(Constants.WAIT_5);
		Button.jsclick("Click Search Button", btnReqIdEnterSearch, driver);
		Sync.waitForSeconds(Constants.WAIT_5);
		return Button.jsclick("Click Open Task", btnOpenTask, driver);
	...
	public void clickOnOpenTask() {
		...
		if(Button.verifyObject(btnOpenTask)) {
			Button.jsclick("Click Open Task", btnOpenTask, driver);
		}
		else {
			Sync.waitForSeconds(Constants.WAIT_5);
			Button.jsclick("Click Open Task", btnOpenTask, driver);
	...
	public boolean approvalBtnClick() {
		...
		Button.jsclick("Click Local Action button", btnlocalAction, driver);
		Sync.waitForSeconds(Constants.WAIT_2);
	...
	public void approvalBtnClick_Global() {
		...
		// Button.jsclick("Click Local Action button", btnlocalAction);
		Sync.waitForSeconds(Constants.WAIT_2);
	...
	public boolean submitGlobalRequest_draft() {
		...
		btnselect.build();
		btnselect.perform();
		return Button.jsclick("Click Ok Button", btnMsgReqIdOk, driver);
	}
	...
	public void okbuttonClick() {
		...
		try {
...

			{
				...
				Button.jsclick("Click close Button", btnMsgClose, driver);
