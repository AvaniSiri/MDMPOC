...
//	@FindBy(how = How.CSS, using = "div[id^='mxui_widget_NumberInput_'][class^='mx-name-textBox2'] :nth-child(1)")
	...
	//	JavascriptExecutor js;
		...
		//js.executeScript("driver.manage().window().resizeTo(screen.width,screen.height)");
	...
	public boolean clickMaterial(String strPageName) throws InterruptedException {
		...
		if (Button.verifyObject(textMaterial)) {
			...
			Sync.waitForObject(driver, "Materials", textMaterial);
			return Button.jsclick(strPageName,
					Sync.waitForObject(driver, strPageName, By.xpath("//a[normalize-space(.)='" + strPageName + "']")),driver);
		}
	}
	...
	public boolean createMaterialNavigate() throws InterruptedException {
		...
		if (Button.verifyObject(menuCreate)) {
			...
			Sync.waitForSeconds(Constants.WAIT_1);
			return Button.jsclick("Create", menuCreate,driver);
		} else {
			return Button.jsclick("Create", menuCreate,driver);
		}
	}
	...
	public boolean materialTypeSelection() throws InterruptedException {
		...
		if (Button.verifyObject(btnMaterialTypeSelect)) {
			Sync.waitForObject(driver, "Material Type Select", btnMaterialTypeSelect);
			Sync.waitForSeconds(Constants.WAIT_1);
			return Button.jsclick("Material Type Select", btnMaterialTypeSelect,driver);
		} else {
			return Button.jsclick("Material Type Selection", btnMaterialTypeSelect,driver);
		}
	}
	...
	public boolean createButtonClick() throws InterruptedException {
		...
		if (Button.verifyObject(btnCreate)) {
			...
			return Button.jsclick("Create Button Click", btnCreate,driver);
		} else {
			return Button.jsclick("Create Button Click", btnCreate,driver);
		}
	...
	public boolean disableLocaData() {
		...
		Button.jsclick("Disable Local Request", btnDisableLocalRequest,driver);
	    Button.jsclick("Proceed", btnProceed,driver);
	    Sync.waitForSeconds(Constants.WAIT_5);
	    return Button.jsclick("Local Actions button", btnLocalActions,driver);
	}
	...
	public boolean materialGrpSelectionTest(String strValue) throws InterruptedException {
		...
		try {
			...
			Button.jsclick("Click On Ok on Error Popup", btnOK,driver);
		}
		Sync.waitForSeconds(Constants.WAIT_5);
		JavascriptExecutor js;
		js = (JavascriptExecutor) driver;
		...
		Button.jsclick("Click Search Button", btnMaterialGrpSearch,driver);
		Sync.waitForSeconds("5");
		Button.jsclick("Click CMG Search result", txtCMGSelect,driver);
		Sync.waitForObject(driver, "Wait for Material Group Selection Text Box", btnMaterialGroupSelect);
		return Button.jsclick("Click Material Group Select", btnMaterialGroupSelect,driver);
	...
	public void unitOfWeightSelectionTest(String strValue) throws InterruptedException {
		...
		Button.jsclick("Click Unit of Weight selecction button", btnUnitofWeight);
		...
		Button.jsclick("Click Search Unit of Weight button", btnUnitofWeightSearch);
		...
		btnselect.build();
		btnselect.perform();
		Button.jsclick("Click Unit Of Weight Select Button", btnUnitofWeightSelect);	
*/		
		
		Sync.waitForElementToBeClickable(driver, btnUnitofWeight);		
		Sync.waitForSeconds(Constants.WAIT_5);
		Button.jsclick("Click Unit of Weight selecction button", btnUnitofWeight,driver);
		Sync.waitForObject(driver, "Wait for Unit Of weight", txtboxUnitofWeightInput);
		Sync.waitForSeconds(Constants.WAIT_5);
		Textbox.enterValue("Enter Unit of Weight", txtboxUnitofWeightInput, strValue);
		Sync.waitForObject(driver, "Wait for UOM popup", btnUnitofWeightSearch);
		Button.jsclick("Click Search Unit of Weight button", btnUnitofWeightSearch,driver);
		Sync.waitForSeconds(Constants.WAIT_10);
		...
		btnselect.build();
		btnselect.perform();
		Button.jsclick("Click Base UOM select button", btnBaseUOMSelect,driver);
	...
	public void baseUOMSelectionTest(String strValue) throws InterruptedException {
		...
		Sync.waitForSeconds(Constants.WAIT_5);
		Button.jsclick("Click Base UOM selection button", btnBaseUOMSelection,driver);
		...
		Button.jsclick("Click Base UOM Search button", btnBaseUOMSearch,driver);
	...
	public boolean netWeightEnterTest(String strValue) throws InterruptedException {
		...
		Button.jsclick("Click Net Weight Enter TextBox", txtboxNetWeight,driver);
	...
	public boolean validateTestCreate() {
		...
		if(Button.verifyObject(btnLocalActions))
		{
			...
			Sync.waitForSeconds(Constants.WAIT_6);
			Sync.waitForSeconds(Constants.WAIT_1);
			Button.jsclick("Click Validate", btnValidate,driver);
	...
	public void validate() {
		...
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//*[text()='Validate']"))));
				if(Button.verifyObject(btnValidate))  {
					Sync.waitForSeconds(Constants.WAIT_5);
					Button.jsclick("Click on Validate",btnValidate,driver);
				}
				else {
					Button.jsclick("Click on Validate",btnValidate,driver);
				}
	...
	public void DuplicateCheck() {
		...
		Sync.waitForSeconds(Constants.WAIT_6);
		Sync.waitForSeconds(Constants.WAIT_1);
		Button.jsclick("Click Duplicate check", btnDuplicateCheck,driver);
		// click on popup No matches / possible duplicates have been found.
		Sync.waitForObject(driver, btnOK);
		Button.jsclick("Click On Ok on duplicate check info popup", btnOK,driver);
	 ...
	 * 
	 * Button.jsclick("Click Global submit Global Request", btnGlobalRequest);
	 ...
	 * 
	 * 
	 * Button.jsclick("Local Actions button click", btnLocalActions);
	 ...
	 * btnOK); Button.jsclick("Click On OK button", btnOK); Thread.sleep(2000); }
	 */

	/*
	 * public void DiscardCreateGDA() throws InterruptedException {
	 * 
	 * Thread.sleep(6000); Button.jsclick("Local Actions button click",
	 ...
	 * Button.jsclick("Click On OK button", btnOK); Thread.sleep(2000); }
	 */
	...
	public void submitGlobalandLocalRequestTest() throws InterruptedException {
		...
		Sync.waitForSeconds(Constants.WAIT_5);
		Sync.waitForObject(driver, "Verify Validate message", txtValidationMsg);
		Button.jsclick("Click Global submit Global Request", btnLocalRequest,driver);
		Sync.waitForSeconds(Constants.WAIT_2);
		Thread.sleep(8000);
	}
	...
	public String getRequestId() throws InterruptedException, FileNotFoundException, IOException {
		...
		Button.jsclick("Click Ok Button", btnOK,driver);
		return Id;
	}
	...
	public boolean validateTestCreateLocal() {
		Sync.waitForSeconds(Constants.WAIT_6);
		Sync.waitForSeconds(Constants.WAIT_1);
		Button.jsclick("Click Validate", btnValidateLocalRequest,driver);
		return Sync.waitForObject(driver, "Verify Validate message", txtValidationMsg);
	}
	...
	public String getRequestIdOne() throws InterruptedException, FileNotFoundException, IOException {
		 ...
		 * 
		 * Button.jsclick("Click Ok Button", btnMsgReqIdOk);
		 */
		return Id;
	}
	...
	public void SaveAsDraft() throws InterruptedException {
		...
		Button.jsclick("Click Save as Draft", btnSavingAsDraft,driver);
		Sync.waitForSeconds(Constants.WAIT_5);
		// Sync.waitForSeconds(Constants.WAIT_6);
	}
	...
	public String getRequestId_draft() throws InterruptedException, FileNotFoundException, IOException {
		...
		// Button.jsclick("Click Ok Button", btnMsgReqIdOkdraft);
		return Id;
	}
	 ...
	 * Sync.waitForSeconds(Constants.WAIT_3);
	 * Sync.waitForElementToBeClickable(driver, btnMsgReqIdOkdraft); //
	 * Button.jsclick("Click Ok Button", btnMsgReqIdOkdraft); return Id; }
	 */
	 ...
	 * Button.jsclick("Click Materials Menu", textMaterial); return
	 * Button.jsclick("Click Dashboard Menu", menuMaterialDashboard); }
	 */
	...
	public void advancedSearch() throws InterruptedException {
		...
		Button.jsclick("Click Advanced Search", btnAdvancedSearch,driver);
	...
	public void reqIdSearchGlobal(String strValue) throws InterruptedException {
		...
		Button.jsclick("Click Search button", btnReqIdEnter,driver);
		Sync.waitForSeconds(Constants.WAIT_2);
	}
	...
	public boolean clickFullMaterialData() {
		...
		return Button.jsclick("Click Get Full Material Data", btnFullMaterailData,driver);
	}
	 ...
	 * btnFullMaterailData); Button.jsclick("Click Materials Menu",
	 ...
	 * Button.jsclick("Click Get Full Material Data", btnFullMaterailData);
	 * 
	 * }
	 */
	public void clickFullMaterialDataNew() {
		...
		Sync.waitForSeconds(Constants.WAIT_2);
		Sync.waitForObject(driver, "Wait until the Material appears", btnFullMaterailData);
		Button.jsclick("Click Materials Menu", btnFullMaterailData,driver);
		Sync.waitForSeconds(Constants.WAIT_10);
		/*
	...
	public void clickFullMaterialDataDeletion() throws InterruptedException {
		...
		Sync.waitForSeconds(Constants.WAIT_5);
		Sync.waitForObject(driver, "Wait until the Material appears", btnFullMaterailData);
		Button.jsclick("Click Get Full Materaial", btnFullMaterailData,driver);
		/*
		 * WebElement waitElement = null; FluentWait<WebDriver> fwait = new
	 ...
	 * Sync.waitForObject(driver, btnOK); Button.jsclick("Click On OK button", btnOK);
	 * Sync.waitForSeconds(Constants.WAIT_5); }
	 */
	...
	public boolean clickGlobalDataButton() throws InterruptedException {
		 ...
		 * Button.jsclick("Global Data", btnGlobalData); }else{ return
		 * Button.jsclick("Global Data", btnGlobalData); }
		 */
	...
	public boolean clickToConfirm() throws InterruptedException {
		...
		if (Button.verifyObject(btnToConfirm)) {
			...
			Sync.waitForSeconds(Constants.WAIT_5);
			return Button.jsclick("Click Button To Confirm", btnToConfirm,driver);
		} else {
			return Button.jsclick("Click Button To Confirm", btnToConfirm,driver);
		}
	}
	...
	public boolean clickConfirmExtension() throws InterruptedException {
		...
		if (Button.verifyObject(btnConfirmExtension)) {
			...
			Sync.waitForSeconds(Constants.WAIT_5);
			return Button.jsclick("Click Button To Confirm", btnConfirmExtension,driver);
		} else {
			return Button.jsclick("Click Button To Confirm", btnConfirmExtension,driver);
		}
	}
	...
	public boolean clickOk() throws InterruptedException {
		...
		if (Button.verifyObject(btnok)) {
			...
			Sync.waitForSeconds(Constants.WAIT_5);
			return Button.jsclick("Click Button To ok", btnok,driver);
		} else {
			return Button.jsclick("Click Button To ok", btnok,driver);
		}
	...
	public void DiscardCreateGDA() throws InterruptedException {
		...
		Sync.waitForObject(driver, btnOK);
		Button.jsclick("Click On OK button", btnOK,driver);
		Sync.waitForSeconds(Constants.WAIT_5);
	}
	...
	public void RejectLocalRequest() {
		...
		Button.jsclick("Click  Reject Local Request",
				driver.findElement(By.xpath(".//*[text()='Reject Local Request']")),driver);
	...
	public void duplicateCheck() {
		try {
			...
			Button.jsclick("Click Ok Button", btnMsgReqIdOk,driver);

			/*
			 * try { if(btnMsgReqIdOkdraft.isEnabled()) { Button.jsclick("Click Ok Button",
...
*/		WebDriverWait wait = new WebDriverWait(driver, 150);
	...
	public void validateAndDuplicateCheckButton() {
		...
		if (Button.verifyObject(btnValidateDuplicateCheck)) {
			...
			Button.jsclick("Click on Duplicate button", btnValidateDuplicateCheck,driver);
		} else {
			Button.jsclick("Clicked on Duplicate button", btnValidateDuplicateCheck,driver);
		}
	}
	...
	public void validateDuplicateCheck() {
		...
		if (Button.verifyObject(validateDuplicate)) {
			Sync.waitForSeconds(Constants.WAIT_5);
			Button.jsclick("Click on Validate and duplicate check", validateDuplicate,driver);
		} else if (Button.verifyObject(btnClose)) {
	...
	public void validateAndsubmitGlobalLocalRequest() {
		...
		Button.jsclick("Local Actions button", btnLocalActions,driver);
		Sync.waitForSeconds(Constants.WAIT_6);
		Button.jsclick("Validate Local Data", btnValidateLocalRequest,driver);
		Sync.waitForSeconds(Constants.WAIT_6);
		Sync.waitForObject(driver, "Verify Validate message", txtValidationMsg);
		Sync.waitForSeconds(Constants.WAIT_5);
		...
		Sync.waitForSeconds(Constants.WAIT_5);
		// Sync.waitForObject(driver, textLocalData);
		//Button.jsclick("Click Global and Local submit Request", btnGlobalLocalRequest);
		//Sync.waitForSeconds(Constants.WAIT_5);
	...
	public void submitGlobalLocalRequest() {
		...
		Sync.waitForSeconds(Constants.WAIT_6);
//		Sync.waitForObject(driver, btnLocalActions);
//		Button.jsclick("Local Actions button", btnLocalActions);
//		Sync.waitForSeconds(Constants.WAIT_6);
//		Button.jsclick("Validate Local Data", btnValidateLocalRequest);
//		Sync.waitForSeconds(Constants.WAIT_6);
//		Sync.waitForObject(driver, "Verify Validate message", txtValidationMsg);
//		Sync.waitForSeconds(Constants.WAIT_5);
	...
	//	Button.jsclick("Click on Popup", popUp, driver);
		...
		Button.jsclick("Click on Edit", btnEdit, driver);
		Sync.waitForSeconds(Constants.WAIT_5);
		Sync.waitForSeconds(Constants.WAIT_5);
		// WebElement dropdownWHTValue
		...
		// Button.jsclick("Wait for WHT posting group Select", dropdownWHTValue);
		...
		Button.jsclick("Local Actions button", btnLocalActions, driver);
		Sync.waitForSeconds(Constants.WAIT_6);
		Button.jsclick("Validate Local Data", btnValidateLocalData,driver);
		Sync.waitForSeconds(Constants.WAIT_6);
		Sync.waitForObject(driver, "Verify Validate message", txtValidationMsg);
		Sync.waitForSeconds(Constants.WAIT_5);
		Sync.waitForSeconds(Constants.WAIT_5);
		Button.jsclick("Save Local Data", btnSaveLocalData, driver);
		Sync.waitForSeconds(Constants.WAIT_5);
	...
	public void selectWHTValueInDropDown(String strValue) throws InterruptedException {
		...
		if (DropDown.verifyObject(dropdownWHTValue)) {
			...
			Sync.waitForSeconds(Constants.WAIT_5);
			Button.jsclick("Wait for WHT posting group Select", dropdownWHTValue, driver);
			Select roundVATPostingGroupDown = new Select(dropdownWHTValue);
			roundVATPostingGroupDown.selectByVisibleText(strValue);
...
//		Sync.waitForSeconds(Constants.WAIT_10);
		...
		Button.jsclick("Click on Save Button", btnSave, driver);
		Sync.waitForSeconds(Constants.WAIT_2);
		//Sync.waitForObject(driver, btnLocalActions);
		//Button.jsclick("Local Actions button click", btnLocalActions);
		Sync.waitForSeconds(Constants.WAIT_2);
	...
	public void rejectLDSBank() throws AWTException {
		...
		Button.jsclick("Click on reject button in locl action", btnRejectBankRequest, driver);
		Sync.waitForSeconds(Constants.WAIT_2);
		Sync.waitForObject(driver, btnOK);
		Button.jsclick("Click On OK button", btnOK, driver);
		Sync.waitForSeconds(Constants.WAIT_5);
	...
	public void submitLocalRequestTest() throws InterruptedException {
		...
		if (Button.verifyObject(btnLocalRequest)) {
			...
			Sync.waitForSeconds(Constants.WAIT_5);
			Button.jsclick("Click Submit Local Request", btnLocalRequest, driver);
			Sync.waitForSeconds(Constants.WAIT_5);
		} else {
			Sync.waitForSeconds(Constants.WAIT_6);
			Sync.waitForSeconds(Constants.WAIT_1);
